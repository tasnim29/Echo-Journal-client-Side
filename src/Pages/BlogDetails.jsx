...
const BlogDetails = () => {
  ...
  return (
    <div className="py-36">
      <div
        className={`rounded-md shadow-2xl max-w-2xl mx-auto  px-5 ${
          ...
          <div className="space-y-3">
            ...
            <form onSubmit={handleComment}>
              <textarea
                ...
                className="w-full p-2 rounded text-sm border-2 border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary dark:bg-white dark:text-gray-900"
              />
              <button type="submit" className="btn btn-accent text-secondary">
                Add Comment
              </button>
            </form>
          </div>
